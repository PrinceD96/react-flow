...
const getNodeStyles = (nodeType: string, isHighlighted: boolean) => {
  const baseClasses = "px-4 py-3 rounded-lg border-2 bg-white shadow-lg transition-all duration-200 hover:shadow-xl min-w-[140px]";
...
const TableNode = memo(({ data, selected }: NodeProps) => {
  ...
  const isHighlighted = selected || Boolean(nodeData.recommendation_id);
