    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="text-center text-gray-500">
          ...
          <div className="text-lg font-medium text-gray-900 mb-2">No recommendations available</div>
          <div className="text-sm">This insight doesn't have any specific recommendations yet.</div>
        </div>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        {recommendations.map((recommendation, index) => (
          <div
            ...
            className={`bg-white rounded-lg border-2 p-6 transition-all duration-200 cursor-pointer hover:shadow-md ${
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2">
                  <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium border ${getEvidenceColor(recommendation.evidence_source)}`}>
              ...
              <div className="mt-4 p-3 bg-orange-100 border border-orange-200 rounded-lg">
                <div className="flex items-center gap-2 text-sm text-orange-800">
                  ...
                  <span className="font-medium">
                    Highlighting related elements in the query plan
                  </span>
                </div>
              </div>
            )}
